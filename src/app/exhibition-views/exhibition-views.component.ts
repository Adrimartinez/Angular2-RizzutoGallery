...
@Component({
    selector: 'app-exhibition-views',
    templateUrl: './exhibition-views.component.html',
    styleUrls: ['../app.component.css']
})
export class ExhibitionViewsComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        this.by = this.homeService.getBy();
        document.getElementsByTagName('body')[0].className = 'page-id-11';
        this.getExhibitions();
        this.count = 0;
