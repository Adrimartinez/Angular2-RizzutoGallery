import {
    Component, Input, OnInit, ViewEncapsulation, trigger, state, style, transition, animate
}
    from '@angular/core';
...
export class ShareContainerComponent implements OnInit {
    ...
    fetchProperties() {
        ...
        this.properties.title = this.properties.title || this.getMetaContent('og:title');
